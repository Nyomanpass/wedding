...
// === LOGIC SLIDESHOW HEADER (6 Detik) ===
  ...
  return (
    ...
    <section
      className={`w-full md:max-w-md mx-auto py-16 px-8 ${VEDA_BG} text-center`}
    >
      {/* Icon */}
      <div
        className="mb-10"
      ...
      >
        <div
          className={`w-28 h-28 mx-auto flex items-center justify-center rounded-full border border-white/50 text-white shadow-lg shadow-white/10`}
        >
          <HeartHandIcon
            className="w-14 h-14 animate-pulse text-pink-300"
            data-aos="flip-left"
            data-aos-delay="200"
          />
        </div>
      ...
      <p
        data-aos="fade-up"
        data-aos-delay="400"
        className={`text-lg leading-relaxed italic mx-auto max-w-sm text-white font-light mb-10`}
      >
        Wahai pasangan suami-istri, semoga kalian tetap bersatu dan tidak pernah
        terpisahkan. Semoga kalian mencapai hidup penuh kebahagiaan, tinggal di
        rumah yang penuh kegembiraan bersama seluruh keturunanmu.
      </p>
      ...
      <p
        data-aos="fade-up"
        data-aos-delay="800"
        className={`text-md font-bold tracking-wider text-white font-serif`}
      >
        <span className="text-xl mr-2" data-aos="zoom-in" data-aos-delay="900">
          📜
        </span>
        RG VEDA X.85.42.
      </p>
...
<section
  id="welcome"
  className={`min-h-screen ${BG_COLOR} ${PRIMARY_COLOR} flex flex-col items-center p-8 pt-12`}
>
  {/* OM SWASTYASTU */}
  <h1
    data-aos="fade-down"
    className="text-3xl font-serif mb-6 text-center tracking-widest text-white"
  >
    OM SWASTYASTU
  </h1>
  ...
  <p
    data-aos="fade-up"
    data-aos-delay="200"
    className="text-center italic max-w-lg text-sm mb-12 text-gray-400"
  >
  ...
  >
    ...
    {/* Foto Groom */}
    <div
      className="w-full h-full rounded-lg bg-gray-700 overflow-hidden mb-8 shadow-xl border border-gray-700"
      data-aos="fade-up"
      data-aos-delay="400"
    >
      <img
    ...
    {/* Nama & Detail */}
    <h3
      className="text-4xl font-serif tracking-widest text-white mb-1"
      data-aos="fade-up"
      data-aos-delay="500"
    >
      RESTU
    ...
    <p
      className="font-light text-xl text-white text-center"
      data-aos="fade-up"
      data-aos-delay="600"
    >
    ...
    <p
      className="text-sm text-center max-w-xs mt-3 text-gray-400"
      data-aos="fade-up"
      data-aos-delay="700"
    >
    ...
    <div
      className="w-2/3 h-px bg-gray-600 mt-4 mb-4"
      data-aos="fade-up"
      data-aos-delay="800"
    />
    <p
      className="text-sm text-center max-w-xs text-gray-400 px-4"
      data-aos="fade-up"
      data-aos-delay="900"
    >
  ...
  {/* --- THE BRIDE SECTION --- */}
  <div
    className="flex flex-col items-center mb-20 relative pt-10"
    data-aos="fade-up"
    data-aos-delay="300"
  >
    {/* Foto Bride */}
    ...
    <p
      ...
      data-aos-delay="700"
    >
      Putri dari pasangan <br /> Ketut Sarjana & <br /> Neneng Farida
    </p>
    <div
      className="w-2/3 h-px bg-gray-600 mt-4 mb-4"
      data-aos="fade-up"
  ...
  <section
      id="acara"
      className="w-full md:max-w-md mx-auto relative overflow-hidden h-[80vh]"
    >
      {/* --- Background Gambar Full Overlay --- */}
      <div
      ...
      {/* --- Strip Vertikal Kiri --- */}
      <div
        className={`absolute left-0 top-0 h-full w-20 ${VEDA_BG} flex items-center justify-center shadow-lg z-10`}
        data-aos="fade-right"
        data-aos-delay="300"
      >
      ...
      {/* --- Konten Detail Resepsi --- */}
      <div
        className={`relative z-20 flex flex-col pl-20 items-center text-center pt-16 px-6 h-full text-white`}
      >
        {/* Kalimat Pembuka */}
        <p
          className="text-base italic max-w-xs mb-8"
          data-aos="fade-up"
          data-aos-delay="300"
        >
        ...
        {/* Header Acara */}
        <h2
          className="text-4xl font-serif tracking-widest mb-10"
          data-aos="zoom-in"
          data-aos-delay="500"
        >
          RESEPSI
        ...
        >
          {/* Tanggal Besar */}
          <span className="text-8xl font-serif leading-none opacity-80">
            28
          </span>
          {/* Hari, Bulan, Tahun */}
        ...
        <p
          className="text-base text-center max-w-xs mb-10 font-light"
          data-aos="fade-up"
          data-aos-delay="800"
        >
          Jl. Raya Uluwatu Gg. Kunyit Pecatu, Kec. Kuta Selatan, Kab. Badung -
          Bali
        </p>

        {/* Garis Pemisah */}
        <div
          className="w-2/3 h-px bg-white opacity-40 my-4"
          data-aos="zoom-in"
          data-aos-delay="900"
        />
        ...
        {/* Tombol Map */}
        <button
          className={`flex items-center px-6 py-3 mt-8 ${VEDA_BG} text-white font-semibold rounded-lg shadow-md hover:bg-opacity-90 transition`}
          data-aos="fade-up"
          data-aos-delay="1000"
        >
       ...
       <section
      id="countdown"
      className="w-full md:max-w-md mx-auto relative overflow-hidden text-white"
    >
      {/* --- Gambar dan Overlay --- */}
      <div
        className="relative w-full bg-gray-900 h-[50vh] px-8 pt-28"
        data-aos="fade-up"
      >
        <div
          className="relative w-full h-full bg-gray-900 rounded-lg overflow-hidden shadow-xl"
          data-aos="zoom-in"
          data-aos-delay="200"
        >
          <img
          ...
          <div
            className="absolute inset-0 flex flex-col justify-center items-center text-center z-10 px-6 pt-16"
            data-aos="fade-up"
            data-aos-delay="400"
          >
            ...
            <p className="italic text-gray-200 text-sm">Save The Date</p>
      ...
      {/* --- Bagian Countdown --- */}
      <div
        className={`relative w-full py-16 px-8 bg-gray-900 text-white text-center h-[25%]`}
        data-aos="fade-up"
        data-aos-delay="600"
      >
        {/* Timer */}
        <div
          className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-30 w-full max-w-xs md:max-w-sm"
          data-aos="fade-down"
          data-aos-delay="800"
        >
          <div className="flex w-full justify-between">
            {Object.entries(timeLeft).map(([label, value], i) => (
              <div
                ...
                data-aos="flip-up"
                data-aos-delay={900 + i * 150} // delay tiap kotak biar berurutan
              >
        ...
        {/* Teks bawah */}
        <div className="pt-2" data-aos="fade-up" data-aos-delay="1100">
          ...
          <p className="text-sm text-gray-400 italic max-w-sm mx-auto leading-relaxed">
            ...
            Tapi disaat pasangan yang tidak sempurna belajar untuk menikmati
            perbedaan mereka.
          </p>
        </div>
      </div>
